"""
Django settings for cyberLearning project.
...
SECRET_KEY = 'django-insecure-$v8md)3n&z%337a2kr5$i7*57ejw@ca-0$so!z3ivok8c%kgd+'
...
WSGI_APPLICATION = 'cyberLearning.wsgi.application'
